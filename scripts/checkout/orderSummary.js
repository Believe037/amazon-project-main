...
import { cart, updateQuantity, updateDeliveryOption } from "../../data/cart.js";
...
export function renderOrderSummary() {
  ...
  cart.forEach((cartItem) => {
    ...
    // This code takes the productId and finds a matching product.
              ...
              <div class="cart-item-details-grid">
                ...
                <div class="cart-item-details">
                  ...
                  <div class="product-quantity">
                    <span>
                      Quantity: <span class="quantity-label js-item-quantity-update-${matchingProduct.id}">${cartItem.quantity}</span>
                    </span>
  ...
  document.querySelectorAll('.js-update-link').forEach((itemUpdate) => {
    itemUpdate.addEventListener('click', () => {
      const productId = itemUpdate.dataset.productId
      document.querySelector(`.js-cart-item-container-${productId}`).classList.add('is-editing-quantity');
      
    })
  })
  // for save - update links
